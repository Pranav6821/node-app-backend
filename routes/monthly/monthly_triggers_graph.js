...
var Monthly_triggers_graph =require('../../models/daily_triggers');
var date1;
var date2;
let app =express();

monthly_triggers_graph = function(req , res){
  date1 = new Date()
  ...
  Monthly_triggers_graph.aggregate([{$match:{Users_id:req.params._id}},{$unwind:"$Daily"},
...
module.exports = monthly_triggers_graph;
