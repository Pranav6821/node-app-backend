...
var Monthly_symptoms_graph =require('../../models/daily_symptoms');
var date1;
var date2;
let app =express();

monthly_symptoms_graph = function(req , res){
  date1 = new Date()
  ...
  Monthly_symptoms_graph.aggregate([{$match:{Users_id:req.params._id}},{$unwind:"$Daily"},
...
module.exports = monthly_symptoms_graph;
