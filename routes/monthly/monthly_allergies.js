...
var Monthly_allergiess =require('../../models/daily_allergies');
var date1;
var date2;
let app =express();

monthly_allergies = function(req , res){
  date1 = new Date()
...
Monthly_allergiess.aggregate([{$match:{Users_id:req.params._id}},{"$unwind":"$Daily"},
...
module.exports = monthly_allergies;
