...
var Weekly_triggers=require('../../models/daily_triggers');
var date1;
var date2;
let app =express();

weekly_triggers = function(req , res){
  date1 = new Date()
  ...
  Weekly_triggers.aggregate([{$match:{Users_id:req.params._id}},{"$unwind":"$Daily"},
...
module.exports = weekly_triggers;
