...
var Monthly_medication_rescue_graph = require('../../models/daily_medicine_rescue');
var date1;

var date2;
let app =express();

  monthly_medication_rescue_graph = function(req , res){
    date1 = new Date()
    ...
    Monthly_medication_rescue_graph.aggregate([{$match:{Users_id:req.params._id}},{"$unwind":"$Daily"},
...
module.exports = monthly_medication_rescue_graph;
