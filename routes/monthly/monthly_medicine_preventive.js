...
var Monthly_medication_preventive = require('../../models/daily_medicine_preventive');
var date1;
var date2;
let app =express();

  monthly_medication_preventive = function(req , res){
    date1 = new Date()
    ...
    Monthly_medication_preventive.aggregate([{$match:{Users_id:req.params._id}},{"$unwind":"$Daily"},
...
module.exports = monthly_medication_preventive;
